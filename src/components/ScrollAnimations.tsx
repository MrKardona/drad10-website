...
export function ScrollAnimations() {
  // Este componente vive en el layout raíz, que no se desmonta al navegar con
  // <Link>. Si solo corriera al montar, la página siguiente quedaría con todo
  // [data-anim] en opacity:0 (lo fija globals.css) y se vería en blanco.
  // Por eso se reinicia en cada cambio de ruta.
  const pathname = usePathname();

  useEffect(() => {
    // El contexto agrupa solo lo creado aquí: al cambiar de ruta se revierte
    // sin tocar los ScrollTrigger de otros componentes (secuencias, /nosotros).
