    ...
    <header className="w-full bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a href="https://www.facebook.com/clinicaquantum.co/" target="_blank" rel="noopener noreferrer" aria-label="Facebook Clínica Quantum">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
          </a>
          <a href="https://www.instagram.com/clinicaquantum.co/" target="_blank" rel="noopener noreferrer" aria-label="Instagram @clinicaquantum.co">
          ...
          <a href="https://wa.me/573043751975" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <a href="https://www.tiktok.com/@clinica.quantum" target="_blank" rel="noopener noreferrer" aria-label="TikTok @clinica.quantum">
