...
const nav: NavItem[] = [
  ...
  { label: "NOSOTROS", href: "/nosotros" },
  {
    ...
    sub: [
      ...
      { label: "Limpiezas Faciales", href: "/servicios/limpieza-facial" },
      ...
      { label: "Relleno de Labios", href: "/servicios/relleno-de-labios" },
  ...
  },
  {
    ...
    href: "/#capilares",
    sub: [
      { label: "Implante Capilar FUE", href: "/servicios/implante-capilar-fue" },
