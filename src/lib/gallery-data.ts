...
export const galleryCases: GalleryCase[] = [
  ...
  },
  {
    ...
    zone: "Entrecejo",
    category: "inyectable",
    antes: `${R}/botox-entrecejo-3-antes.webp`,
    despues: `${R}/botox-entrecejo-3-despues.webp`,
    aspectRatio: "4 / 3",
    description:
      "Mismo gesto antes y después: al fruncir el ceño, las líneas del entrecejo se marcan mucho menos.",
  },
  {
    id: "botox-entrecejo-4",
    title: "Menos marca al fruncir",
    treatment: "Toxina botulínica",
    zone: "Entrecejo",
    category: "inyectable",
    antes: `${R}/botox-entrecejo-4-antes.webp`,
    despues: `${R}/botox-entrecejo-4-despues.webp`,
    aspectRatio: "4 / 3",
    description:
      "Mismo gesto antes y después: al fruncir el ceño, las líneas del entrecejo se marcan mucho menos.",
  },
  {
    id: "botox-entrecejo-5",
    title: "Entrecejo sin surcos profundos",
    treatment: "Toxina botulínica",
    zone: "Entrecejo",
    category: "inyectable",
    antes: `${R}/botox-entrecejo-5-antes.webp`,
    despues: `${R}/botox-entrecejo-5-despues.webp`,
    aspectRatio: "4 / 3",
    description:
      "Mismo gesto antes y después: al fruncir el ceño, las líneas del entrecejo se marcan mucho menos.",
  },
  {
    id: "botox-entrecejo-6",
    title: "Líneas del ceño suavizadas",
    treatment: "Toxina botulínica",
    zone: "Entrecejo",
    category: "inyectable",
    antes: `${R}/botox-entrecejo-6-antes.webp`,
    despues: `${R}/botox-entrecejo-6-despues.webp`,
    aspectRatio: "4 / 3",
    description:
      "Mismo gesto antes y después: al fruncir el ceño, las líneas del entrecejo se marcan mucho menos.",
  },
  ...
  {
    id: "rinomodelacion-5",
    title: "Dorso nasal más recto",
    treatment: "Rinomodelación",
    zone: "Nariz",
    category: "inyectable",
    antes: `${R}/rinomodelacion-5-antes.webp`,
    despues: `${R}/rinomodelacion-5-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Perfil del mismo lado antes y después de la rinomodelación con ácido hialurónico, sin cirugía.",
  },
  {
    id: "rinomodelacion-6",
    title: "Perfil nasal armonizado",
    treatment: "Rinomodelación",
    zone: "Nariz",
    category: "inyectable",
    antes: `${R}/rinomodelacion-6-antes.webp`,
    despues: `${R}/rinomodelacion-6-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Perfil del mismo lado antes y después de la rinomodelación con ácido hialurónico, sin cirugía.",
  },
  {
    id: "rinomodelacion-7",
    title: "Punta nasal con más proyección",
    treatment: "Rinomodelación",
    zone: "Nariz",
    category: "inyectable",
    antes: `${R}/rinomodelacion-7-antes.webp`,
    despues: `${R}/rinomodelacion-7-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Perfil del mismo lado antes y después de la rinomodelación con ácido hialurónico, sin cirugía.",
  },
  {
    id: "rinomodelacion-8",
    title: "Giba nasal disimulada",
    treatment: "Rinomodelación",
    zone: "Nariz",
    category: "inyectable",
    antes: `${R}/rinomodelacion-8-antes.webp`,
    despues: `${R}/rinomodelacion-8-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Perfil del mismo lado antes y después de la rinomodelación con ácido hialurónico, sin cirugía.",
  },
  ...
  {
    id: "labios-5",
    title: "Labios con más definición",
    treatment: "Relleno de labios",
    zone: "Labios",
    category: "inyectable",
    antes: `${R}/labios-5-antes.webp`,
    despues: `${R}/labios-5-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Foto frontal con la misma expresión antes y después del relleno con ácido hialurónico.",
  },
  {
    id: "labios-6",
    ...
    zone: "Labios",
    category: "inyectable",
    antes: `${R}/labios-6-antes.webp`,
    despues: `${R}/labios-6-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Foto frontal con la misma expresión antes y después del relleno con ácido hialurónico.",
  },
  {
    id: "labios-7",
    title: "Contorno y color más marcados",
    treatment: "Relleno de labios",
    zone: "Labios",
    category: "inyectable",
    antes: `${R}/labios-7-antes.webp`,
    despues: `${R}/labios-7-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Foto frontal con la misma expresión antes y después del relleno con ácido hialurónico.",
  },
  {
    id: "labios-8",
    title: "Labios hidratados y con forma",
    treatment: "Relleno de labios",
    zone: "Labios",
    category: "inyectable",
    antes: `${R}/labios-8-antes.webp`,
    despues: `${R}/labios-8-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Foto frontal con la misma expresión antes y después del relleno con ácido hialurónico.",
  },
  {
    id: "labios-9",
    title: "Más volumen, mismo rostro",
    treatment: "Relleno de labios",
    zone: "Labios",
    category: "inyectable",
    antes: `${R}/labios-9-antes.webp`,
    despues: `${R}/labios-9-despues.webp`,
    aspectRatio: "1 / 1",
    description:
      "Foto frontal con la misma expresión antes y después del relleno con ácido hialurónico.",
  },
