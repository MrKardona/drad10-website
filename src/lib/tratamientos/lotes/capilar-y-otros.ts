...
export const capilarYOtros: Tratamiento[] = [
  ...
  // ── Aparatología capilar con INDIBA ──────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "Muchas veces nos enfocamos en el cabello y olvidamos el cuero cabelludo, que es donde el folículo necesita buenas condiciones para crecer fuerte.",
        "La aparatología con INDIBA estimula el cuero cabelludo de forma cómoda y sin agujas, y suma a los demás tratamientos de tu plan capilar.",
      ],
    },
    queEs: {
      titulo: "Qué es la aparatología capilar con INDIBA",
      desc: "Es un tratamiento con radiofrecuencia e INDIBA aplicado en el cuero cabelludo. La energía genera un calor suave que favorece la oxigenación y la estimulación de la zona. Es no invasivo, se siente cálido y agradable, y funciona mejor como parte de un plan capilar definido en la valoración.",
    },
    ...
    pasos: [
      { num: "01", title: "Diagnóstico capilar", desc: "Revisamos tu cuero cabelludo con el analizador capilar y definimos cómo encaja INDIBA en tu plan.", detail: "Valoración médica previa" },
      { num: "02", title: "Sesión de INDIBA", desc: "Aplicamos radiofrecuencia sobre el cuero cabelludo. Sientes un calor suave y agradable durante la sesión.", detail: "Aprox. 30 min" },
      { num: "03", title: "Ciclo y seguimiento", desc: "Completas el paquete de 10 sesiones y revisamos la evolución de tu cabello.", detail: "10 sesiones" },
    ],
    seguridad: [
    ...
    faq: [
      { q: "¿Cuánto cuesta el paquete de INDIBA capilar?", a: "El paquete de 10 sesiones tiene un valor de $800.000 COP." },
      { q: "¿Se siente algo?", a: "Se siente un calor suave en el cuero cabelludo. La mayoría de pacientes lo describe como relajante." },
      { q: "¿Cada cuánto son las sesiones?", a: "Habitualmente se programan una o dos veces por semana. Lo ajustamos a tu plan en la valoración." },
      { q: "¿Cuándo se notan los cambios?", a: "Los cambios en el cabello son progresivos y se aprecian a lo largo del ciclo de sesiones y de los meses siguientes." },
      { q: "¿Tiene efectos secundarios?", a: "Puede quedar un enrojecimiento leve o sensación de calor en la zona por un rato después de la sesión." },
      { q: "¿Se puede combinar con otros tratamientos?", a: "Sí. Es un buen complemento de la mesoterapia capilar, el PRP o los exosomas." },
      { q: "¿Quién no puede hacerlo?", a: "No se indica en personas con marcapasos u otros dispositivos implantados, en embarazo ni con infecciones activas en el cuero cabelludo." },
    ],
  ...
  // ── Otomodelización ──────────────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "El cabello siempre suelto, evitar ciertas fotos o cortes de pelo. Las orejas muy separadas pueden hacerte sentir observado aunque nadie diga nada.",
        "La otomodelización mejora la posición de las orejas para que acompañen tu rostro con naturalidad y puedas llevar el cabello como quieras.",
      ],
    },
    queEs: {
      titulo: "Qué es la otomodelización",
      desc: "Es una cirugía menor que remodela la forma o el ángulo de las orejas para acercarlas a la cabeza y mejorar su posición. Se realiza con anestesia local y la incisión se ubica habitualmente detrás de la oreja, donde la cicatriz queda poco visible. Después se usa una banda o vendaje durante un tiempo para proteger el resultado.",
    },
    ...
    pasos: [
      { num: "01", title: "Valoración y planeación", desc: "Evaluamos la forma y posición de tus orejas, revisamos tu salud y te explicamos qué cambio es realista.", detail: "Valoración médica previa" },
      ...
      { num: "03", title: "Vendaje, puntos y control", desc: "Revisamos la cicatrización, retiramos los puntos cuando corresponde y te indicamos cuánto tiempo usar la banda.", detail: "Controles de seguimiento" },
    ],
    seguridad: [
    ...
    faq: [
      { q: "¿Cuánto cuesta la otomodelización?", a: "La corrección de orejas tiene un valor de $2.300.000 COP. En la valoración confirmamos que es lo indicado para tu caso." },
      ...
      { q: "¿Cuánto dura la recuperación?", a: "Habitualmente retomas actividades tranquilas en pocos días. La banda se usa por un tiempo según indicación y los deportes de contacto se evitan unas semanas." },
      { q: "¿Se nota la cicatriz?", a: "La incisión se ubica detrás de la oreja, por lo que queda poco visible una vez madura." },
      { q: "¿Qué efectos secundarios son normales?", a: "Inflamación, morado leve, sensibilidad o adormecimiento temporal de las orejas." },
      { q: "¿Cuándo veo el resultado?", a: "Se aprecia desde que retiramos el vendaje y mejora a medida que baja la inflamación en las semanas siguientes." },
      { q: "¿Quién no puede hacérsela?", a: "No está indicada con infecciones activas en la zona, embarazo, lactancia, alteraciones de la coagulación o condiciones médicas no controladas." },
    ],
  ...
  // ── Despigmentación de zona íntima y axilas ──────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        ...
        "Con un protocolo médico podemos aclarar y emparejar ese tono de forma progresiva, cuidando una piel que es especialmente sensible.",
      ],
    },
    queEs: {
      titulo: "Qué es la despigmentación de zona íntima y axilas",
      desc: "Es un protocolo médico para aclarar y emparejar el tono de la piel en zonas donde se acumula pigmento. Según la valoración se combinan productos y procedimientos despigmentantes aptos para piel sensible, junto con indicaciones para evitar lo que la oscurece. La mejoría es progresiva y requiere constancia.",
    },
    ...
    pasos: [
      ...
      { num: "02", title: "Protocolo despigmentante", desc: "Aplicamos el protocolo indicado para tu tipo de piel, cuidando la sensibilidad de cada zona.", detail: "Aprox. 30 a 45 min" },
      { num: "03", title: "Seguimiento y cuidado en casa", desc: "Revisamos la evolución sesión a sesión y te damos indicaciones para mantener el resultado.", detail: "Resultados progresivos" },
    ],
    seguridad: [
    ...
    faq: [
      { q: "¿Cuánto cuesta la despigmentación?", a: "El precio depende de las zonas a tratar y del protocolo indicado. Lo definimos en la valoración." },
      { q: "¿Duele?", a: "Suele ser tolerable. Puede haber ardor, calor o sensibilidad leve durante o después de la sesión, según el protocolo." },
      { q: "¿Cuántas sesiones necesito?", a: "Depende del grado de pigmentación y de tu piel. Habitualmente se requieren varias sesiones y constancia con los cuidados en casa." },
      { q: "¿Cuándo se ven los resultados?", a: "El aclaramiento es progresivo y se nota a lo largo de las sesiones." },
      { q: "¿La mancha puede volver?", a: "Sí, si persisten el roce, la depilación agresiva o los cambios hormonales. Por eso te damos indicaciones para mantener el resultado." },
      { q: "¿Qué efectos secundarios son normales?", a: "Enrojecimiento, descamación leve, sensibilidad o sensación de ardor pasajera." },
      { q: "¿Puedo combinarlo con depilación láser?", a: "En muchos casos sí, porque reducir la depilación con cuchilla o cera ayuda a evitar que la zona se oscurezca. Lo organizamos en la valoración." },
      { q: "¿Quién no puede hacérselo?", a: "No está indicado en embarazo, lactancia, heridas o infecciones activas en la zona, ni sobre manchas que no han sido valoradas." },
    ],
  ...
  // ── Sueroterapia intravenosa ─────────────────────────────────────────────
  {
    ...
    queEs: {
      ...
      desc: "Es la administración por vía intravenosa de una mezcla de vitaminas y antioxidantes, bajo supervisión médica. Tenemos varias líneas: détox, inmunológica, antienvejecimiento, adelgazante, post quirúrgica, deportiva, antiestrés, megadosis de vitamina C y energía. Es un complemento de bienestar y no cura enfermedades; la línea se elige después de valorar tu salud.",
    },
    ...
    pasos: [
      ...
      { num: "02", title: "Sesión de sueroterapia", desc: "Canalizamos una vena y administramos el suero con calma, mientras descansas cómodamente con supervisión.", detail: "30 a 60 min" },
      { num: "03", title: "Seguimiento", desc: "Revisamos cómo te sentiste y definimos si conviene repetir, con qué frecuencia o con qué otra línea.", detail: "Según tu plan" },
    ],
    seguridad: [
    ...
    faq: [
      { q: "¿Cuánto cuesta la sueroterapia?", a: "Cada sesión tiene un valor de $200.000 COP, en cualquiera de las líneas." },
      { q: "¿Qué líneas tienen?", a: "Détox, inmunológica, antienvejecimiento, adelgazante, post quirúrgica, deportiva, antiestrés, megadosis de vitamina C y energía." },
      { q: "¿La sueroterapia cura enfermedades?", a: "No. Es un complemento de bienestar. No reemplaza el tratamiento médico, la alimentación ni el descanso." },
      { q: "¿Duele?", a: "Solo se siente el pinchazo de la canalización. Durante la sesión puedes descansar cómodamente." },
      { q: "¿Cuánto dura la sesión?", a: "Habitualmente entre 30 y 60 minutos, según la línea." },
      { q: "¿La línea adelgazante me hace bajar de peso?", a: "No por sí sola. Es un complemento dentro de un plan con alimentación, actividad física y seguimiento médico." },
      { q: "¿Qué efectos secundarios pueden aparecer?", a: "Un morado leve en el sitio de la punción, sensación de frío en el brazo o, con menos frecuencia, mareo. Te acompañamos durante toda la sesión." },
  ...
  // ── Masajes de relajación ────────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        ...
        "Este masaje está pensado para frenar: dos horas y media en las que sueltas la tensión de la cabeza a los pies y te regalas un descanso real.",
      ],
    },
    queEs: {
      titulo: "Qué incluye el masaje de relajación",
      desc: "Es una sesión de 2 h 30 que recorre todo el cuerpo: masaje craneal para liberar la tensión de la cabeza, masaje facial para relajar el rostro y masaje corporal con piedras volcánicas, cuyo calor ayuda a soltar los músculos y a profundizar la sensación de descanso.",
    },
    ...
    pasos: [
      { num: "01", title: "Bienvenida y preguntas previas", desc: "Te preguntamos por tu salud, zonas de tensión y preferencias de presión para adaptar la sesión a ti.", detail: "Antes de empezar" },
      { num: "02", title: "Masaje craneal, facial y corporal", desc: "Recorremos cabeza, rostro y cuerpo, e integramos piedras volcánicas para profundizar la relajación.", detail: "2 h 30" },
      { num: "03", title: "Cierre y recomendaciones", desc: "Te damos un momento para incorporarte con calma y recomendaciones para prolongar la sensación de descanso.", detail: "Al terminar" },
    ],
    seguridad: [
    ...
    faq: [
      { q: "¿Cuánto cuesta el masaje de relajación?", a: "La sesión de 2 h 30 tiene un valor de $250.000 COP e incluye masaje craneal, facial y corporal con piedras volcánicas." },
      { q: "¿Cuánto dura?", a: "Dos horas y media. Te recomendamos llegar unos minutos antes." },
      { q: "¿Las piedras volcánicas queman?", a: "No deben. Controlamos su temperatura antes de usarlas y puedes pedir que ajustemos el calor en cualquier momento." },
      { q: "¿Es un masaje terapéutico?", a: "Es un masaje de relajación enfocado en soltar tensión y descansar. Si tienes dolor o una lesión específica, podemos orientarte hacia otras opciones." },
      { q: "¿Puedo combinarlo con otros tratamientos?", a: "Sí. Muchos pacientes lo combinan con sueroterapia o con un facial como Hydrafacial para una jornada de bienestar." },
