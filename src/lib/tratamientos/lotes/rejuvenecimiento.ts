...
export const rejuvenecimiento: Tratamiento[] = [
  ...
  // ── Hydrafacial ───────────────────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "Contaminación, maquillaje, sol y estrés se acumulan en los poros. La piel pierde brillo y se siente áspera, aunque sigas tu rutina en casa.",
        "A veces solo necesitas una limpieza a fondo y una buena hidratación para volver a verte con la piel fresca.",
      ],
    },
    queEs: {
      titulo: "Qué es Hydrafacial",
      desc: "Es un tratamiento facial con tecnología Hydrafacial que combina en una sola sesión limpieza, exfoliación suave, extracción de impurezas por succión e infusión de sueros con nutrientes e hidratantes. Es cómodo, no requiere recuperación y deja la piel hidratada y luminosa desde el primer día.",
    },
    ...
    pasos: [
      {
        ...
        desc: "Revisamos tu tipo de piel, con analizador facial cuando aplica, para elegir el protocolo y los sueros adecuados.",
        detail: "Antes de la sesión",
      },
      {
        num: "02",
        title: "Sesión de Hydrafacial",
        desc: "Limpiamos, exfoliamos, extraemos impurezas y aplicamos la infusión de nutrientes. Es una experiencia cómoda y relajante.",
        detail: "45 a 60 min",
      },
      {
        num: "03",
        title: "Resultado y rutina",
        desc: "Sales con la piel hidratada y luminosa. Te damos recomendaciones de cuidado en casa y la frecuencia ideal.",
    ...
    faq: [
      { q: "¿Cuánto cuesta un Hydrafacial?", a: "La sesión de Hydrafacial, limpieza facial profunda con multinutrientes, tiene un valor de $220.000." },
      { q: "¿Duele?", a: "No suele doler. Es un tratamiento cómodo; en la extracción puedes sentir una succión suave." },
      { q: "¿Cuándo se ven los resultados?", a: "Desde la primera sesión: la piel queda más limpia, hidratada y luminosa." },
      { q: "¿Cada cuánto me lo puedo hacer?", a: "Habitualmente una vez al mes, según tu piel y tus objetivos. Te recomendamos la frecuencia en la sesión." },
      { q: "¿Deja la piel roja?", a: "Puede quedar un enrojecimiento leve que desaparece en pocas horas. Puedes volver a tu rutina el mismo día." },
      { q: "¿Qué diferencia tiene con una limpieza facial?", a: "Ambas limpian a fondo. Hydrafacial usa su tecnología para extraer por succión e infundir sueros con nutrientes en la misma sesión." },
      { q: "¿Se puede combinar con otros tratamientos?", a: "Sí. Es una buena preparación para tratamientos médicos de la piel. Te orientamos sobre tiempos y combinaciones." },
    ],
  ...
  // ── Limpieza facial profunda ──────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "Poros tapados, puntos negros, brillo o textura áspera: muchas veces es acumulación que el lavado diario no logra retirar del todo.",
        "Una limpieza profunda bien hecha le devuelve a tu piel su equilibrio y hace que tus productos y tratamientos funcionen mejor.",
      ],
    },
    queEs: {
      titulo: "Qué incluye la limpieza facial profunda",
      desc: "Es un protocolo por fases: revisión de tu piel, limpieza, exfoliación, preparación de los poros, extracción cuidadosa de comedones, mascarilla según tu tipo de piel, hidratación y protección. Se adapta a cada piel, ya sea grasa, seca, mixta o sensible.",
    },
    ...
    pasos: [
      {
        num: "01",
        title: "Diagnóstico de tu piel",
        desc: "Evaluamos tu tipo de piel y su sensibilidad, con analizador facial cuando aplica, para armar el protocolo.",
        detail: "Antes de la sesión",
      },
      {
        num: "02",
        title: "Limpieza por fases",
        desc: "Limpieza, exfoliación, extracción cuidadosa, mascarilla e hidratación, con productos elegidos para tu piel.",
        detail: "60 a 90 min",
      },
      {
        num: "03",
        title: "Rutina y frecuencia",
        desc: "Te dejamos recomendaciones de cuidado en casa y la frecuencia ideal, habitualmente cada 4 a 8 semanas.",
    ...
    faq: [
      { q: "¿Cuánto cuesta la limpieza facial profunda?", a: "La sesión de limpieza facial profunda tiene un valor de $150.000." },
      { q: "¿Duele la extracción?", a: "Puede generar una molestia leve en algunas zonas. Preparamos los poros antes para que sea lo más cómoda posible." },
      { q: "¿Queda la piel roja?", a: "Es normal un enrojecimiento leve por algunas horas, sobre todo en las zonas de extracción." },
      { q: "¿Cada cuánto debo hacérmela?", a: "Habitualmente cada 4 a 8 semanas, según tu tipo de piel. Te recomendamos la frecuencia en la sesión." },
      { q: "¿Sirve si tengo acné?", a: "En acné leve puede ayudar a descongestionar. Si el acné es inflamado, primero lo valoramos para indicarte un tratamiento médico." },
  ...
  // ── Porcelanización facial ────────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "La piel apagada, con zonas más oscuras o un tono irregular, hace que te veas cansada aunque te maquilles. Y el maquillaje no siempre logra disimularlo.",
        "Una piel limpia y con tono uniforme refleja mejor la luz. Ese acabado liso y luminoso es lo que buscamos con la porcelanización.",
      ],
    },
    queEs: {
      titulo: "Qué es la porcelanización facial",
      desc: "Es un protocolo de cosmetología que empieza con una limpieza profunda y termina con una mascarilla aclarante. Retira impurezas y células muertas, y ayuda a que el tono de la piel se vea más uniforme y luminoso. No es un tratamiento para manchas profundas: para esos casos te orientamos a opciones médicas.",
    },
    ...
    pasos: [
      ...
      },
      {
        ...
        desc: "Hacemos una limpieza profunda y aplicamos la mascarilla aclarante, con productos adecuados a tu piel.",
        detail: "60 a 90 min",
      },
      {
        num: "03",
        title: "Resultado y cuidados",
        desc: "Sales con la piel luminosa. Te damos indicaciones de protección solar y cuidado para mantener el acabado.",
    ...
    faq: [
      { q: "¿Cuánto cuesta la porcelanización facial?", a: "La sesión, que incluye limpieza profunda y mascarilla aclarante, tiene un valor de $180.000." },
      ...
      { q: "¿Duele?", a: "No suele doler. Durante la extracción puede haber una molestia leve y la mascarilla puede generar un cosquilleo." },
      { q: "¿Cuándo se ve el resultado?", a: "Desde el mismo día notas la piel más luminosa y suave." },
      { q: "¿Cada cuánto me la puedo hacer?", a: "Depende de tu piel. Te recomendamos la frecuencia en la sesión, habitualmente con varias semanas entre una y otra." },
      { q: "¿Puedo tomar sol después?", a: "Es mejor evitar el sol directo los días siguientes y usar protector solar a diario para cuidar el acabado." },
    ],
  ...
  // ── Alta hidratación facial ───────────────────────────────────────────────
  {
    ...
    problema: {
      ...
      parrafos: [
        "La piel reseca se siente tirante, se ve apagada y marca líneas finas que antes no notabas. El maquillaje se cuartea y las cremas parecen no alcanzar.",
        "Devolverle a tu piel la hidratación que perdió cambia cómo se ve y cómo se siente, desde la primera sesión.",
      ],
    },
    queEs: {
      titulo: "Qué es la alta hidratación facial",
      desc: "Es un protocolo de cosmetología que combina una limpieza profunda con una mascarilla hidratante. Primero retiramos impurezas y células muertas para que la piel reciba mejor los activos, y luego aplicamos la hidratación. El resultado es una piel más suave, flexible y luminosa.",
    },
    ...
    pasos: [
      {
        num: "01",
        title: "Diagnóstico de tu piel",
        desc: "Revisamos tu nivel de hidratación y sensibilidad, con analizador facial cuando aplica, para elegir los productos.",
        detail: "Antes de la sesión",
      },
      {
        num: "02",
        title: "Limpieza y mascarilla hidratante",
        desc: "Hacemos una limpieza profunda y aplicamos la mascarilla hidratante adecuada a tu tipo de piel.",
        detail: "60 a 90 min",
      },
      {
        num: "03",
        title: "Resultado y rutina",
        desc: "Sales con la piel suave y luminosa. Te recomendamos cómo mantener la hidratación en casa.",
    ...
    faq: [
      { q: "¿Cuánto cuesta la alta hidratación facial?", a: "La sesión, que incluye limpieza profunda y mascarilla hidratante, tiene un valor de $150.000." },
      { q: "¿Duele?", a: "No suele doler. Es un tratamiento cómodo y relajante; en la extracción puede haber una molestia leve." },
      { q: "¿Cuándo se nota?", a: "Desde la misma sesión: la piel se siente suave, cómoda y se ve más luminosa." },
      { q: "¿Cada cuánto me la puedo hacer?", a: "Depende de qué tan reseca esté tu piel. Te recomendamos una frecuencia en la sesión." },
      ...
      { q: "¿Se puede combinar con otros tratamientos?", a: "Sí. Puede alternarse con Hydrafacial o limpieza facial según tu piel. Te orientamos en la sesión." },
    ],
